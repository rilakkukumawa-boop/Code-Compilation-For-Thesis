...
plt.imshow(img_s_detect, origin='lower', cmap='magma') #regions combined with 
#median in between
plt.colorbar() #color bar 
apertures_s.plot(color='red') # plotted circles aperture plot
plt.show()
...
plt.figure()
plt.scatter(Fr_final, Fs_final, s=10, color='black')
